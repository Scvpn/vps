...
clear
# Link Hosting Kalian
wget -0 https://raw.githubusercontent.com/Scvpn/vps/main/sstp.sh
chmod +x sstp
IP=$(wget -qO- ipinfo.io/ip);
...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/Scvpn/vps/main/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/Scvpn/vps/main/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/Scvpn/vps/main/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/Scvpn/vps/main/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/Scvpn/vps/main/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
