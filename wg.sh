...
# ==================================================
# Link Hosting Kalian
wget https://raw.githubusercontent.com/Scvpn/vps/main/wg.sh
chmod +x wg
# Check OS version
...
iptables -I INPUT 1 -i $SERVER_PUB_NIC -p udp --dport 636 -j ACCEPT
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/Scvpn/vps/main/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/Scvpn/vps/main/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/Scvpn/vps/main/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
