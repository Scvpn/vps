...
# ==================================================
# Link Hosting Kalian
wget https://raw.githubusercontent.com/Scvpn/vps/main/ipsec.sh"
chmod +x ipsec
...
wget -O /usr/bin/addl2tp https://raw.githubusercontent.com/Scvpn/vps/main/addl2tp.sh && chmod +x /usr/bin/addl2tp
wget -O /usr/bin/dell2tp https://raw.githubusercontent.com/Scvpn/vps/main/dell2tp.sh && chmod +x /usr/bin/dell2tp
wget -O /usr/bin/addpptp https://raw.githubusercontent.com/Scvpn/vps/main/addpptp.sh && chmod +x /usr/bin/addpptp
wget -O /usr/bin/delpptp https://raw.githubusercontent.com/Scvpn/vps/main/delpptp.sh && chmod +x /usr/bin/delpptp
wget -O /usr/bin/renewpptp https://raw.githubusercontent.com/Scvpn/vps/main/renewpptp.sh && chmod +x /usr/bin/renewpptp
wget -O /usr/bin/renewl2tp https://raw.githubusercontent.com/Scvpn/vps/main/renewl2tp.sh && chmod +x /usr/bin/renewl2tp
